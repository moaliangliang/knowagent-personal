...
const WORKFLOW_PRESETS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { type: "navigate", config: { value: "https://ivpn.sanygroup.com/portal/#/login", desc: "打开登录页" } },
      { type: "wait", config: { seconds: 3, desc: "等待页面加载" } },
      { type: "cmd_call", config: { cmd: "auto_web", action: "navigate", url: "https://ivpn.sanygroup.com/portal/#/login", desc: "浏览器打开VPN登录页" } },
      { type: "cmd_call", config: { cmd: "notification", text: "请在浏览器中完成 VPN 登录，然后运行 三一 CloudClient 登录", desc: "提示" } },
    ],
  },
  {
    ...
    icon: "🔐",
    steps: [
      { type: "cmd_call", config: { cmd: "vpn_connect", company: "三一", desc: "切换三一VPN配置" } },
      { type: "cmd_call", config: { cmd: "open_url", url: "https://ivpn.sanygroup.com/portal/#/login", desc: "打开VPN登录页" } },
      { type: "wait", config: { seconds: 4, desc: "等待页面加载" } },
      { type: "cmd_call", config: { cmd: "auto_click", text: "请输入账号", desc: "点击账号输入框" } },
      { type: "cmd_call", config: { cmd: "keyboard_type", text: "gw_maoll", desc: "输入用户名" } },
      { type: "cmd_call", config: { cmd: "auto_click", text: "请输入密码", desc: "点击密码输入框" } },
      { type: "cmd_call", config: { cmd: "keyboard_type", text: "Pisx@0401", desc: "输入密码" } },
      { type: "cmd_call", config: { cmd: "auto_click", text: "我已阅读并同意", desc: "勾选用户协议" } },
      { type: "cmd_call", config: { cmd: "auto_click", text: "登录", desc: "点击登录" } },
      { type: "wait", config: { seconds: 8, desc: "等待登录" } },
