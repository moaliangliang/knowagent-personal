...
TOOL_SCHEMAS: dict = {
    "todo_add": {
        ...
        "properties": {
            ...
            "category": {"type": "string", "description": "分类，如 work/study/life"},
    ...
    "todo_list": {
        ...
        "properties": {
            ...
            "include_done": {"type": "string", "description": "是否包含已完成"},
        },
    },
    "todo_done": {
        "type": "object",
        "properties": {
            "id": {"type": "integer", "description": "事项编号"},
        },
        "required": ["id"],
    },
    "todo_undo": {
    ...
    "todo_delete": {
        "type": "object",
        "properties": {
            "id": {"type": "integer", "description": "事项编号（0=删除所有待办）"},
        },
        "required": ["id"],
    },
