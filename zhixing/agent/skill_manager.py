...
Skills are Python files placed in ~/.zhixing/skills/ that define a Skill subclass
(see zhixing.plugins.Skill). This manager handles the lifecycle:
...
from zhixing.plugins import Skill, Plugin, auto_register_skill

SKILL_DIR = os.path.expanduser("~/.zhixing/skills")
    ...
    def _download_skill(self, url: str) -> str:
        ...
        try:
            req = urllib.request.Request(
                url,
                headers={"User-Agent": "ZhixingSkillManager/1.0"},
            )
