...
from .auto import COMMANDS as _AUTO_COMMANDS, TOOL_SCHEMAS as _AUTO_SCHEMAS
...
from .keychain import COMMANDS as _KEYCHAIN_COMMANDS, TOOL_SCHEMAS as _KEYCHAIN_SCHEMAS
...
from .messaging import COMMANDS as _MESSAGING_COMMANDS, TOOL_SCHEMAS as _MESSAGING_SCHEMAS
from .plugin_tools import COMMANDS as _PLUGIN_COMMANDS, TOOL_SCHEMAS as _PLUGIN_SCHEMAS
from .system_tools import COMMANDS as _SYSTEM_COMMANDS, TOOL_SCHEMAS as _SYSTEM_SCHEMAS
from .todo import COMMANDS as _TODO_COMMANDS, TOOL_SCHEMAS as _TODO_SCHEMAS

# ── Aggregated registries ──────────────────────────────────

ALL_COMMANDS: dict = {}
ALL_COMMANDS.update(_AI_COMMANDS)
ALL_COMMANDS.update(_AUTO_COMMANDS)
...
ALL_TOOL_SCHEMAS.update(_KEYCHAIN_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_MEDIA_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_MONITOR_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_NETWORK_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_MESSAGING_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_PLUGIN_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_SYSTEM_SCHEMAS)
ALL_TOOL_SCHEMAS.update(_TODO_SCHEMAS)
