"""Configuration management - reads ~/.zhixing/config.yaml."""
...
CONFIG_DIR = os.path.expanduser("~/.zhixing")
...
DEFAULT_CONFIG = {
    ...
    "proxy": {
        ...
        # 安全提示：用户名密码请通过 zhi credential 存入 macOS Keychain
        "fortinet": {
            "host": "60.190.246.42",
            "port": 10443,
            "username": "",
        ...
        "companies": {
            ...
            "三一": {
                "name": "三一集团",
                "vpn_type": "atrust",
                "vpn_host": "ivpn.sanygroup.com",
                "vpn_port": 443,
                "vpn_username": "gw_maoll",
                "vpn_password": "Pisx@0401",
                "http": "http://127.0.0.1:7890",
                "https": "http://127.0.0.1:7890",
            },
        },
    ...
    "pro": {
        "license_key": "",           # Pro License Key（空=社区版）
    },
    "harness": {
