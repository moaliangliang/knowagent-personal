...
``~/.knowagent/clipboard_history.json`` (max 200 entries).
...
_DATA_DIR = os.path.expanduser("~/.knowagent")
...
def _ensure_data_dir() -> None:
    """Create ~/.knowagent/ if it does not exist."""
...
def cmd_clipboard_monitor_start(params: dict) -> str:
    ...
    saves changes to ~/.knowagent/clipboard_history.json (max 200 entries)."""
